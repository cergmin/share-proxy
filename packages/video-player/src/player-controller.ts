...
.${ROOT_CLASSNAME} .spvp-preview[hidden] {
  display: none;
}
...
.${ROOT_CLASSNAME} .spvp-volume:hover .spvp-volume-range,
.${ROOT_CLASSNAME} .spvp-volume:focus-within .spvp-volume-range {
  width: 96px;
  opacity: 1;
  pointer-events: auto;
}
...
function createIcon(name: string): string {
    if (name === 'play') {
        return '<svg viewBox="0 -960 960 960" aria-hidden="true"><path d="M320-273v-414q0-17 12-28.5t28-11.5q5 0 10.5 1.5T381-721l326 207q9 6 13.5 15t4.5 19q0 10-4.5 19T707-446L381-239q-5 3-10.5 4.5T360-233q-16 0-28-11.5T320-273Z"/></svg>';
    }

    if (name === 'pause') {
        return '<svg viewBox="0 -960 960 960" aria-hidden="true"><path d="M640-200q-33 0-56.5-23.5T560-280v-400q0-33 23.5-56.5T640-760q33 0 56.5 23.5T720-680v400q0 33-23.5 56.5T640-200Zm-320 0q-33 0-56.5-23.5T240-280v-400q0-33 23.5-56.5T320-760q33 0 56.5 23.5T400-680v400q0 33-23.5 56.5T320-200Z"/></svg>';
    }

    if (name === 'backward') {
        return '<svg viewBox="0 -960 960 960" aria-hidden="true"><path d="M360-500h-30q-13 0-21.5-8.5T300-530q0-13 8.5-21.5T330-560h60q13 0 21.5 8.5T420-530v180q0 13-8.5 21.5T390-320q-13 0-21.5-8.5T360-350v-150Zm140 180q-17 0-28.5-11.5T460-360v-160q0-17 11.5-28.5T500-560h80q17 0 28.5 11.5T620-520v160q0 17-11.5 28.5T580-320h-80Zm20-60h40v-120h-40v120ZM339.5-108.5q-65.5-28.5-114-77t-77-114Q120-365 120-440q0-17 11.5-28.5T160-480q17 0 28.5 11.5T200-440q0 117 81.5 198.5T480-160q117 0 198.5-81.5T760-440q0-117-81.5-198.5T480-720h-6l34 34q12 12 11.5 28T508-630q-12 12-28.5 12.5T451-629L348-732q-12-12-12-28t12-28l103-103q12-12 28.5-11.5T508-890q11 12 11.5 28T508-834l-34 34h6q75 0 140.5 28.5t114 77q48.5 48.5 77 114T840-440q0 75-28.5 140.5t-77 114q-48.5 48.5-114 77T480-80q-75 0-140.5-28.5Z"/></svg>';
    }

    if (name === 'forward') {
        return '<svg viewBox="0 -960 960 960" aria-hidden="true"><path d="M339.5-108.5q-65.5-28.5-114-77t-77-114Q120-365 120-440t28.5-140.5q28.5-65.5 77-114t114-77Q405-800 480-800h6l-34-34q-12-12-11.5-28t11.5-28q12-12 28.5-12.5T509-891l103 103q12 12 12 28t-12 28L509-629q-12 12-28.5 11.5T452-630q-11-12-11.5-28t11.5-28l34-34h-6q-117 0-198.5 81.5T200-440q0 117 81.5 198.5T480-160q117 0 198.5-81.5T760-440q0-17 11.5-28.5T800-480q17 0 28.5 11.5T840-440q0 75-28.5 140.5t-77 114q-48.5 48.5-114 77T480-80q-75 0-140.5-28.5ZM360-500h-30q-13 0-21.5-8.5T300-530q0-13 8.5-21.5T330-560h60q13 0 21.5 8.5T420-530v180q0 13-8.5 21.5T390-320q-13 0-21.5-8.5T360-350v-150Zm140 180q-17 0-28.5-11.5T460-360v-160q0-17 11.5-28.5T500-560h80q17 0 28.5 11.5T620-520v160q0 17-11.5 28.5T580-320h-80Zm20-60h40v-120h-40v120Z"/></svg>';
    }

    if (name === 'volume-off') {
        return '<svg viewBox="0 -960 960 960" aria-hidden="true"><path d="M760-481q0-83-44-151.5T598-735q-15-7-22-21.5t-2-29.5q6-16 21.5-23t31.5 0q97 43 155 131.5T840-481q0 108-58 196.5T627-153q-16 7-31.5 0T574-176q-5-15 2-29.5t22-21.5q74-34 118-102.5T760-481ZM280-360H160q-17 0-28.5-11.5T120-400v-160q0-17 11.5-28.5T160-600h120l132-132q19-19 43.5-8.5T480-703v446q0 27-24.5 37.5T412-228L280-360Zm380-120q0 42-19 79.5T591-339q-10 6-20.5.5T560-356v-250q0-12 10.5-17.5t20.5.5q31 25 50 63t19 80Z"/></svg>';
    }

    if (name === 'volume-small') {
        return '<svg viewBox="0 -960 960 960" aria-hidden="true"><path d="M360-360H240q-17 0-28.5-11.5T200-400v-160q0-17 11.5-28.5T240-600h120l132-132q19-19 43.5-8.5T560-703v446q0 27-24.5 37.5T492-228L360-360Zm380-120q0 42-19 79.5T671-339q-10 6-20.5.5T640-356v-250q0-12 10.5-17.5t20.5.5q31 25 50 63t19 80Z"/></svg>';
    }
...
function bootVideoPlayer(target: HTMLElement, options: VideoPlayerOptions): Promise<VideoPlayerHandle> {
    ...
    const updateProgress = () => {
        ...
        const suppressTimelineBadges = !menu.hidden;
        ...
        currentTimeBadge.style.left = `${visualPlayedPercent}%`;
        currentTimeBadge.textContent = formatTime(displayCurrentTime);
        const shellRect = progressShell.getBoundingClientRect();
        const playedX = (visualPlayedPercent / 100) * shellRect.width;
        const hoverX = hoverPercent === null ? null : (hoverPercent / 100) * shellRect.width;
        const currentTimeWidth = getLabelWidth(currentTimeBadge);
        const previewTimeWidth = getLabelWidth(previewTime);
        const overlapThreshold = ((currentTimeWidth + previewTimeWidth) / 2) + 8;
        const closeThreshold = overlapThreshold + 36;
        const hasOverlap = hoverX !== null && Math.abs(hoverX - playedX) < overlapThreshold;
        const isNearHover = hoverX !== null && Math.abs(hoverX - playedX) < closeThreshold;
        currentTimeBadge.dataset.hidden = suppressTimelineBadges || isNearHover ? 'true' : 'false';
        currentTimeBadge.dataset.overlap = suppressTimelineBadges ? 'false' : hasOverlap ? 'true' : 'false';
